...
public class ArrayListClass {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        ArrayListClass.printList(ls);
        ls.sort((String v1, String v2) -> v1.length() - v2.length());
        ...
        */
        ...
        ListIterator<Integer> listIterator1 = ls4.listIterator(); // Iterator starting at the beginning of the list

        System.out.println("Printing list from front using Iterator:");
        while(listIterator1.hasNext()) {
            Integer val = listIterator1.next();
            System.out.print(val + " ");
            if(val == 300) listIterator1.set(350);
            if(val == 200) listIterator1.add(250);
        }
        System.out.println();

        listIterator1 = ls4.listIterator(ls4.size()); // Iterator starting at the end of the list
        while(listIterator1.hasPrevious()) {
            Integer val = listIterator1.previous();
            System.out.print(val + " ");
